...
const BorderLineButton = ({ onClick, children, className = "py-2 px-6 border border-primaryDark-500 rounded-full transition ease-in-out delay-150 hover:border-white active:bg-primary-500 focus:bg-primary-600 focus:text-white focus:outline-none focus:ring focus:ring-primary-200 bg-white hover:bg-primary-500 text-primaryDark-500 hover:text-white" }: { onClick: any, children: any, className?: string }) => {
    return (
