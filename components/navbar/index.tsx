...
export default function Navbar() {
    ...
    return (
        <Disclosure as="nav">
            {({ open }) => (
                <>
                    <div className="mx-auto max-w-7xl px-4 py-4 sm:px-0 border-b" data-aos="zoom-in" data-aos-delay="200">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="gap-3 hidden md:flex" data-aos="zoom-in" data-aos-delay="200">
                                <Link href={'https://calendly.com/team-trident/let-s-talk'} passHref>
                                    <BorderLineButton>
                                        <span>Set a meeting</span>
                                    </BorderLineButton>
                                </Link>
                            </div>
                            <div className="gap-3 flex md:hidden" data-aos="zoom-in" data-aos-delay="200">
                                <Link href={'https://calendly.com/team-trident/let-s-talk'} passHref>
