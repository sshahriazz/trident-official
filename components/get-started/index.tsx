...
const GettingStarted = () => {
  return (
    <div className=" bg-[#D6ECF4] rounded-3xl">
      <div className="w-full h-full relative flex justify-between items-center p-7 md:p-0 md:px-14">
        <div className="">
          ...
          <div className="flex justify-end md:justify-start" data-aos="fade-up" data-aos-delay="350">
            <Button className="w-full sm:w-auto">
              <a href="mailto:hello.teamtrident@gmail.com">{gettingStarted.buttonText}</a>
            </Button>
          </div>
        </div>
